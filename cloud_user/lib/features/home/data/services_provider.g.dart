...
String _$servicesHash() => r'9af1cea4adebb1ee741a31cf6ff8681047df8156';
...
class ServicesFamily extends Family<AsyncValue<List<ServiceModel>>> {
  ...
  /// See also [services].
  ServicesProvider call({String? categoryId}) {
    return ServicesProvider(categoryId: categoryId);
  }
...
class ServicesProvider extends AutoDisposeFutureProvider<List<ServiceModel>> {
  /// See also [services].
  ServicesProvider({String? categoryId})
    : this._internal(
        (ref) => services(ref as ServicesRef, categoryId: categoryId),
  ...
  bool operator ==(Object other) {
    return other is ServicesProvider && other.categoryId == categoryId;
  }
